...
using SmartNZHealth.Models.PatientViewModels;
...
namespace SmartNZHealth.Controllers
{
    ...
    public class PatientController : Controller
    {
        ...
        {
            ICollection<ApplicationUser> patients = new List<ApplicationUser>();
            var users = _context.Users.AsNoTracking().ToList();
            foreach (var user in users)
            {
                var result = _userManager.IsInRoleAsync(user, "Patient");
        ...
        {
            IdentityRole role = await _context.Roles.AsNoTracking().SingleOrDefaultAsync(r => r.Name == "Patient");
